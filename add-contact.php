...
if(isset($_POST['submit'])){
    ...
    //dd($_FILES);
    //$_FILES['pic']['name']=which you have given to image !
    if(isset($_FILES['pic']['name'])){
        $file_name = $_FILES['pic']['name'];

        $temp_file_path = $_FILES['pic']['tmp_name']; //Which server has given 
        //dd($temp_file_path);
        $temp=explode('.',$file_name);
        //dd($temp);//which you have given with extension ->manuser.png
        $extension = end($temp);
//yaha se extension mila and imagename is jo upar small m covert karke kia firstname and lastname ko
